...
public class AcqJobManager extends JobManager {
    ...
    public static class JobBuilder { 
        ...
        private final AcqConfig acqConfig;
        ...
        public JobBuilder(AcqJobManager mgr, String id, AcqConfig config) {
            manager=mgr;
            identifier=id;
            acqConfig=config;
        }
...
*/        
    ...
    public void updateStartTimes(long reference) throws JobException {
        ...
        for (Job job:getJobs()) {
            ...
            if (!(job.getConfiguration() instanceof AcqConfig)) {
                throw new JobException(job,"Job is not instance of AquisitionJob class");
            }
            AcqSetting setting=((AcqConfig)job.getConfiguration()).getAcqSetting();
