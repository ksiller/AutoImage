 ...
 */
public class AcquisitionJob extends Job<AcqConfig> implements ImageCacheListener, IDataProcessorListener {
...
//    private List<ProcessorFactory> processorFactories;
    ...
    public static class AcqJobBuilder {
        ...
        private AcqConfig configuration = null;
...
//        private DataManager dataManager = null;
        ...
        public AcqJobBuilder configure(AcqConfig config) {
...
//                    dataManager,
    ...
    private AcquisitionJob(EventBus evtbus, IAcquisitionEngine2010 eng, CMMCore c, AutofocusManager am, AcqConfig config, Runnable preInit, Runnable postInit, Runnable preRun, Runnable postRun, long timeoutMS, String imgStorageRoot, boolean showAcqDisplay) {
