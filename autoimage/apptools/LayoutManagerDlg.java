...
public class LayoutManagerDlg extends javax.swing.JDialog {
    ...
    private IAcqLayout lastSavedLayout;
    ...
    public LayoutManagerDlg(java.awt.Frame parent, boolean modal) {
        ...
        if (lastFileLocation==null || lastFileLocation.equals(""))
            lastFileLocation=System.getProperty("user.home");
    ...
    private IAcqLayout getCustomLayout() {
        lastSavedLayout.setName((String)platenameField.getValue());
        lastSavedLayout.setFile(new File(fileLocationLabel.getText(),lastSavedLayout.getName()));
        //convert dimensions from mm to um
        lastSavedLayout.setWidth(((Number)plateWidthField.getValue()).doubleValue() * 1000);
        lastSavedLayout.setLength(((Number)plateLengthField.getValue()).doubleValue() * 1000);
        lastSavedLayout.setHeight(((Number)plateHeightField.getValue()).doubleValue() * 1000);
        return lastSavedLayout;
    }
    ...
    private void saveLayout() {
        ...
        if (lastSavedLayout.getFile()==null) {
            lastSavedLayout.setFile(new File(System.getProperty("user.home"),lastSavedLayout.getName()));
        }
        jfc.setCurrentDirectory(lastSavedLayout.getFile().getParentFile());
        String fname=lastSavedLayout.getFile().getName();
        ...
        jfc.ensureFileIsVisible(lastSavedLayout.getFile());
        ...
        do {
            ...
            if (!f.getName().toLowerCase().endsWith(".txt")) {
                JOptionPane.showMessageDialog(this,"Layouts need to be saved as text file. Adding \".txt\" extension");
        ...
        lastSavedLayout=getCustomLayout();
        lastSavedLayout.setName(f.getName());
        lastSavedLayout.setFile(f);
        ...
        try {
            ...
            try {
                JSONObject obj=lastSavedLayout.toJSONObject();
                if (obj!=null) {
...
//                    startUpLayout=config;
        ...
        platenameField.setText(lastSavedLayout.getName());
        lastFileLocation=lastSavedLayout.getFile().getParent();
        fileLocationLabel.setText(lastFileLocation);
        lastSavedLayout.setModified(false);
    }
    ...
    private void openButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openButtonActionPerformed
        ...
        if ("".equals(fileLocationLabel.getText()) || fileLocationLabel.getText()==null) {
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        ...
        lastSavedLayout=new CustomLayout();
 //       if (lastFileLocation.equals("")) {
 //           lastFileLocation=Prefs.getHomeDir();
 //       }
        lastSavedLayout.setFile(new File(lastFileLocation, lastSavedLayout.getName()));
        setCustomLayout(lastSavedLayout);
    ...
    private void removeAreaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeAreaButtonActionPerformed
        List<BasicArea> areas = lastSavedLayout.getAreaArray();
        if (areas.size() > 0) {
            ...
            if (rows.length > 0) {
                ...
                atm.removeRows(rows);
                lastSavedLayout.setModified(true);
            }
        }
    ...
    private void editAreaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editAreaButtonActionPerformed
        ...
        try {
            ...
            BasicArea modArea=areaCopy.showConfigDialog(new Rectangle2D.Double(0,0,lastSavedLayout.getWidth(), lastSavedLayout.getLength()));
...
//                newArea=newArea.showConfigDialog(new Rectangle2D.Double(0,0,width, length));
                newArea=newArea.showConfigDialog(new Rectangle2D.Double(0,0,lastSavedLayout.getWidth(), lastSavedLayout.getLength()));
                if (newArea!=null) {
                    AreaTableModel model=(AreaTableModel)areaTable.getModel();
                    newArea.setId(lastSavedLayout.createUniqueAreaId());
    ...
    private void plateWidthFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_plateWidthFieldPropertyChange
        if (plateWidthField.getValue()!=null && lastSavedLayout!=null) {
            double newValue=((Number)plateWidthField.getValue()).doubleValue() * 1000;
            if (newValue != lastSavedLayout.getWidth()) {
                lastSavedLayout.setWidth(newValue);
                lastSavedLayout.setModified(true);
            }    
        }
    ...
    private void plateLengthFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_plateLengthFieldPropertyChange
        if (plateLengthField.getValue()!=null && lastSavedLayout!=null) {
            double newValue=((Number)plateLengthField.getValue()).doubleValue() * 1000;
            if (newValue != lastSavedLayout.getLength()) {
                lastSavedLayout.setLength(newValue);
                lastSavedLayout.setModified(true);
            }    
        }
    ...
    private void plateHeightFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_plateHeightFieldPropertyChange
        if (plateHeightField.getValue()!=null && lastSavedLayout!=null) {
            double newValue=((Number)plateHeightField.getValue()).doubleValue() * 1000;
            if (newValue != lastSavedLayout.getHeight()) {
                lastSavedLayout.setHeight(newValue);
                lastSavedLayout.setModified(true);
            }    
        }
