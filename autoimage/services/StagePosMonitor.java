...
public class StagePosMonitor extends SwingWorker<Void, Double[]> {
    ...
    public StagePosMonitor(CMMCore core, int interval, boolean readZ, EventBus evtbus) {
    ...
    public StagePosMonitor(CMMCore core, int interval, EventBus evtbus) {
        this (core, interval, true, evtbus);
    }
    
    public StagePosMonitor(CMMCore core, EventBus evtbus) {
        this(core,100, true, evtbus);
    }
...
*/
    ...
    protected void process(final List<Double[]> newPosList) {
        if (newPosList!=null) {
            ...
            eventBus.post(new StagePositionChangedEvent(lastPos));
